    ...
    def best_move(self, row_idx, tile_idx, player_number):
        def checkHorizontal():
            ...
            while left_idx > 0 and (
                ...
                or self.board[row_idx][left_idx - 1] == player_number
            ):
                ...
                if self.board[row_idx][left_idx  - 1] == player_number:
                    left_chance += 1
                    if best_left_move:
            ...
            while right_idx < self.board_size - 1 and (
                ...
                if self.board[row_idx][right_idx + 1] == player_number:
                    right_chance += 1
                    if best_right_move:
        ...
        def checkVertical():
            ...
            while top_idx > 0 and (
                ...
                if self.board[top_idx - 1][tile_idx] == player_number:
                    top_chance += 1
                    if best_top_move:
            ...
            while bottom_idx < self.board_size - 1 and (
                ...
                if self.board[bottom_idx + 1][tile_idx] == player_number:
                    bottom_chance += 1
                    if best_bottom_move:
        ...
        def checkDiagonalLeft():
            ...
            while (
                ...
                if self.board[left[0] + 1][left[1] - 1] == player_number:
                    left_chance += 1
                    if best_left_move:
                        best_left_move.chance = left_chance
                left[0] += 1
            ...
            while (
                ...
                if self.board[right[0] - 1][right[1] + 1] == player_number:
                    right_chance += 1
                    if best_right_move:
                        best_right_move.chance = right_chance
