    ...
    <>
      <Grid
        ...
        sx={{
          ...
          backgroundImage: `background-color: #519657;
...
//   const [isSafe, setIsSafe] = useState(false);
//   const [value, setValue] = useState("");
//   const [selectedPowerUpValue, setSelectedPowerUpValue] =
//     useState(selectedPowerUp);
//   const [selectedPowerUpTilesValues, setSelectedPowerUpTilesValues] =
//     useState(selectedPowerUpTiles);
//   const [isUsingPowerUpValue, setIsUsingPowerUpValue] =
//     useState(isUsingPowerUp);
//   const handleMoveSelect = () => {
//     setSelectedPowerUpTiles([]);
//     setSelectedPowerUp(defaultPowerUp);
//     setIsUsingPowerUp(false);
//   };
//   const handleMoveKeyPress = () => {
//     setSelectedPowerUpTilesValues([]);
//     setSelectedPowerUpValue(defaultPowerUp);
//     setIsUsingPowerUpValue(false);
//   };
...
//     setIsUsingPowerUp(true);
//   };
//   const handlePowerUpKeyPress = async (powerUp: PowerUp, isSameId: boolean) => {
//     setSelectedPowerUpValue(powerUp);
//     setSelectedPowerUpTilesValues([]);
//     setIsUsingPowerUpValue(true);
//   };
//   useEffect(() => {
//     const change = setTimeout(() => {
//       setSelectedPowerUp(selectedPowerUpValue);
//       setSelectedPowerUpTiles(selectedPowerUpTilesValues);
//       setIsUsingPowerUp(isUsingPowerUpValue);
//     }, 100);
//     return () => {
//       clearTimeout(change);
//     };
//   }, [selectedPowerUpValue]);
//   const handleUserKeyPress = useCallback((event) => {
//     const { key, keyCode } = event;
...
//       inventoryList.forEach(async (item) => {
//         if (value === "1" && item.value === 1) {
//           await handlePowerUpKeyPress(item, 1 === selectedPowerUp.value);
//         }
//         if (value === "2" && item.value === 2) {
//           await handlePowerUpKeyPress(item, 2 === selectedPowerUp.value);
//         }
//         if (value === "3" && item.value === 3) {
//           await handlePowerUpKeyPress(item, 3 === selectedPowerUp.value);
//         }
//         if (value === "4" && item.value === 4) {
//           await handlePowerUpKeyPress(item, 4 === selectedPowerUp.value);
//         }
//         if (value === "m") {
//           handleMoveKeyPress();
//         }
